...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `total_download_count` int(11) NOT NULL DEFAULT '0' COMMENT '累计下载次数',
  `total_parse_count` int(11) NOT NULL DEFAULT '0' COMMENT '累计解析次数',
...
CREATE TABLE IF NOT EXISTS `user_point_logs` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_point_logs_open_id` (`open_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户积分流水';

CREATE TABLE IF NOT EXISTS `download_records` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `open_id` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `video_id` varchar(80) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `download_url` varchar(1024) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `points_cost` int(11) NOT NULL DEFAULT '0',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_download_records_open_id` (`open_id`),
  KEY `idx_download_records_video_id` (`video_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='下载记录';
